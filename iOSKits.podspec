#
#  Be sure to run `pod spec lint iOSKits.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "iOSKits"
  spec.version      = "0.0.2"
  spec.summary      = "Utility function for iOS development."
  ...
  spec.source       = { :git => "https://github.com/nghiadev95/iOSKits.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "iOSKits", "iOSKits/**/*.{h,m}"
